...
public class ActivityMore extends AppCompatActivity {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()){
                        ...
                        case R.id.menu_bottom_navigation_search :
                            ...
                            goToActivityFromActivityMore(ActivitySearch.class);
                            break;
    ...
    public  void goToActivityFromActivityMore(Class clazz){
        Intent intent=new Intent(ActivityMore.this,clazz);
